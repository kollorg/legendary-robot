...
[![addon-console](https://img.shields.io/npm/dt/@kollorg/legendary-robot.svg)](https://github.com/kollorg/legendary-robot)
...
[![storybook-addon-console](https://raw.githubusercontent.com/kollorg/legendary-robot/master/docs/storybook-addon-console.png)](https://raw.githubusercontent.com/kollorg/legendary-robot/master/docs/storybook-addon-console.png)
...
```shell
yarn add -D @kollorg/legendary-robot @storybook/addon-actions
```
...
import '@kollorg/legendary-robot';
```
...
import { setConsoleOptions } from '@kollorg/legendary-robot';
...
import { withConsole } from '@kollorg/legendary-robot';
...
## API
<a name="module_@kollorg/legendary-robot"></a>

## @kollorg/legendary-robot
...
* [@kollorg/legendary-robot](#module_@kollorg/legendary-robot)
    * _static_
        * [.setConsoleOptions(optionsOrFn)](#module_@kollorg/legendary-robot.setConsoleOptions) ⇒ <code>addonOptions</code>
        * [.withConsole([optionsOrFn])](#module_@kollorg/legendary-robot.withConsole) ⇒ <code>function</code>
    * _inner_
        * [~addonOptions](#module_@kollorg/legendary-robot..addonOptions) : <code>Object</code>
        * [~optionsCallback](#module_@kollorg/legendary-robot..optionsCallback) ⇒ <code>addonOptions</code>

<a name="module_@kollorg/legendary-robot.setConsoleOptions"></a>

### @kollorg/legendary-robot.setConsoleOptions(optionsOrFn) ⇒ <code>addonOptions</code>
Set addon options and returns a new one

**Kind**: static method of [<code>@kollorg/legendary-robot</code>](#module_@kollorg/legendary-robot)  
**See**
...
```
<a name="module_@kollorg/legendary-robot.withConsole"></a>

### @kollorg/legendary-robot.withConsole([optionsOrFn]) ⇒ <code>function</code>
...
```
<a name="module_@kollorg/legendary-robot..addonOptions"></a>

### @kollorg/legendary-robot~addonOptions : <code>Object</code>
This options could be passed to [withConsole](#storybookaddon-consolewithconsoleoptionsorfn--function) or [setConsoleOptions](#module_@kollorg/legendary-robot.setConsoleOptions)

**Kind**: inner typedef of [<code>@kollorg/legendary-robot</code>](#module_@kollorg/legendary-robot)  
**Properties**
...
<a name="module_@kollorg/legendary-robot..optionsCallback"></a>

### @kollorg/legendary-robot~optionsCallback ⇒ <code>addonOptions</code>
